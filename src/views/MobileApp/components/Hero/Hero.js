...
import Homes from 'svg/illustrations/Home.png';
const Hero = () => {
      ...
      <Grid item container alignItems={'center'} xs={12} md={6}>
        <Box data-aos={isMd ? 'fade-right' : 'fade-up'}>
          <Box marginBottom={2}>
            ...
            >
              Prevent scams calls and deepfakes with <br />
              <Typography
                color={'primary'}
                component={'span'}
                variant={'inherit'}
          ...
          <Box marginBottom={3}>
            <Typography variant="h6" component="p" color="text.secondary">
              An intelligent application to warn users
              <br />
              against deepfakes and scam calls.
            </Typography>
          </Box>
